                            ...
                            <div class="page-title-box">
                                <div class="row">
                                    ...
                                    <div class="col-auto align-self-center">
                                        ...
                                        <div class="nav-link">
                                            <a class=" btn btn-sm btn-soft-primary" href="{{url('admin/type/create')}}" role="button"><i class="fas fa-plus me-2"></i>Add New Type</a>
                                        </div>                                
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">View  Type</h4>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{++$key}}</td>
                                                <td>{{$types->title}}</td>
                                                <td><img src="{{URL::to('/')}}/backend/image/type/{{$types->picture}}"style="width:50px;height:50px;"></td>
                                                <td> 
                                                <form action="{{ route('admin.type.destroy',$types->id) }}" method="POST">
                                                      <a href="{{ route('admin.type.edit',$types->id) }}"class="btn btn-info"><i class="dripicons-document-edit"style="font-size:20px;"></i></a>
                                                    @csrf
                                                @method('DELETE')
