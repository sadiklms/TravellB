                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$bookings->bookingfordate}}</td>

                                               
                                                <td>
                                                <form action="{{ route('admin.coupon.destroy',$bookings->id) }}" method="POST">
                                                      <a href="{{ route('admin.booking-view',$bookings->id) }}"class="btn btn-info"><i class="dripicons-document-edit"style="font-size:20px;"></i></a>
                                                    @csrf
                                                @method('DELETE')
