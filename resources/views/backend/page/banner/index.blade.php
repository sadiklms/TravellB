                            ...
                            <div class="page-title-box">
                                <div class="row">
                                    ...
                                    <div class="col-auto align-self-center">
                                        ...
                                        <div class="nav-link">
                                            <a class=" btn btn-sm btn-soft-primary" href="{{url('admin/banner/create')}}" role="button"><i class="fas fa-plus me-2"></i>Add New Banner</a>
                                        </div>                                
                                ...
                                <div class="card-body">  
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{++$key}}</td>
                                                <td>{{Helper::gettype($banners->type)}}</td>
                                                <td>{{Helper::getsection($banners->type,$banners->section)}}</td>
                                                <td><img src="{{URL::to('/')}}/backend/image/banner/{{$banners->image}}"style="width:50px;height:50px;"></td>
                                                <td>
                                                <form action="{{ route('admin.banner.destroy',$banners->id) }}" method="POST">
                                                      <a href="{{ route('admin.banner.edit',$banners->id) }}"class="btn btn-info"><i class="dripicons-document-edit"style="font-size:20px;"></i></a>
                                                    @csrf
                                                @method('DELETE')
