                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">View Location Type</h4>
                                       
                                    </div><!--end col-->
                                    <div class="col-auto align-self-center">
                                   
                                        <div class="nav-link">
                                            <a class=" btn btn-sm btn-soft-primary" href="{{url('admin/locationtype/create')}}" role="button"><i class="fas fa-plus me-2"></i>Add New Location Type</a>
                                        </div>                                
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">View Location Type</h4>
                                ...
                                <div class="card-body">  
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{++$key}}</td>
                                                <td>{{$locationtypes->title}}</td>
                                                <td><img src="{{URL::to('/')}}/backend/image/locationtype/{{$locationtypes->picture}}"style="width:50px;height:50px;"></td>
                                                <td> 
                                                <form action="{{ route('admin.locationtype.destroy',$locationtypes->id) }}" method="POST">
                                                      <a href="{{ route('admin.locationtype.edit',$locationtypes->id) }}"class="btn btn-info"><i class="dripicons-document-edit"style="font-size:20px;"></i></a>
                                                    @csrf
                                                @method('DELETE')
