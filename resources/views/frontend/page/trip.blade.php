...
<input type="text"id="triptype"name="triptype"value="{{$trip}}">
<input type="text"id="triptypeid"name="tripid"value="{{$id}}">
    <!-- Main Content -->
    <main id="rlr-main" class="rlr-main--fixed-top">
      <div class="rlr-search-results-page container">
        <div class="rlr-search-results-page__breadcrumb-section">
          ...
          <div class="rlr-icon-text"><i class="rlr-icon-font flaticon-phone-receiver-silhouette"> </i> <span class="rlr-search-results-page__phone">{{$generalsetting->phone}} </span></div>
        </div>
        <aside class="row">
          ...
          <div class="rlr-search-results-header rlr-search-results-header__wrapper">
            ...
            <h1 class="rlr-search-results-header__value ">
             ...
             results for
              ...
              @php  $area_type=DB::table('areatypes')->where('id',2)->first();  @endphp
              {{$area_type->title}}
              @endif
             </strong> 
            </h1>
